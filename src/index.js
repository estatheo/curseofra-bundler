...
/**
 * @typedef {Object} HieroglyphicOptions
 * @property {string=} distDir
 * @property {Array<'js'|'mjs'|'cjs'|'css'|'html'>=} includeExtensions
 * @property {string=} banner
 */

/**
 * @param {HieroglyphicOptions=} options
 * @returns {Promise<{filesProcessed:string[]}>}
 */
export async function transpileDistToHieroglyphics(options = {}) {
 ...
 * @param {HieroglyphicOptions=} options
 */
export function viteHieroglyphicsPlugin(options = {}) {
  return {
 ...
 */
export function encodeToHieroglyphics(content) {
